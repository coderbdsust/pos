...
public class Message {
    ...
    public static String ERROR_NOT_HAVE_STAFF_OR_SHOP = "NOT HAVE ENOUGH STAFF OR SHOP, PLEASE CREATE!";
    public static String ERROR_SAME_USERNAME_OR_MOBILE = "SAME USERNAME OR MOBILE";
    public static String ERROR_NOT_PROPER_USER = "MAY BE YOU ARE NOT PROPER USER!";
    public static String ERROR_DUPLICATE_DATA = "SORRY, MAY BE DUPLICATE DATA!";
    public static String ERROR_MINIMUM_QUANTITY_NEED = "PLEASE, SET MINIMUM QUANTITY!";
    ...
    public static String SUCCESS_USER_CREATED = "USER SUCCESSFULLY CREATED";
    public static String SUCCESS_BARCODE_PDF_CREATED = "BARCODE PDF IS CREATED SUCCESSFULLY IN THE SOFTWARE DIRECTORY";
